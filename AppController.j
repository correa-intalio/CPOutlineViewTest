...
@implementation OutlineItemCustomView : CPBox
{
}
...
- (id)initWithFrame:(CGRect)aFrame
{
    self = [super initWithFrame:aFrame];
        ...
        if (self)
        {
            ...
            [self setBoxType:CPBoxSecondary];
...
{
    CPLog.trace("Set object value: " + anObject);
}
@end

@implementation OutlineHeaderCustomView : CPBox
{
}
...
- (id)initWithFrame:(CGRect)aFrame
{
    self = [super initWithFrame:aFrame];
        ...
        if (self)
        {
            ...
            [self setBoxType:CPBoxSecondary];
            [self setBorderType:CPLineBorder];
            [self setBorderColor:[CPColor yellowColor]];
        }
        return self;
}
- (void)setObjectValue:(id)anObject
